...
//   });
// }
// EJERCICIO 3:Probar los distintos eventos
const form = document.querySelector("form")[0];
const emailInput = document.querySelector("#mail");

// Comprobamos que tanto form como emailInput existen
if (form && emailInput) {
  emailInput.addEventListener("input", (event) => {
    // checkValidity comprueba que se cumple con el formato de email
